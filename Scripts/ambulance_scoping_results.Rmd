...
* It's harder to see delays in c1 from these graphs
* Based on this, it looks like c2 trends are more similar to c3 and c4, and a delay in c2 often means a delay in c3 and then a delay in c4 (with some exceptions). c3 and c4 response times are very similar.  
* In North East and Yorkshire and Midlands c4 response times are sometimes better than c3 response times. 
...
* It's harder to see delays in c1 from these graphs
* Based on this, it looks like c2 trends are more similar to c3 and c4, and a delay in c2 often means a delay in c3 and then a delay in c4 (with some exceptions). c3 and c4 response times are very similar.  
* In East Midlands and North East c4 response times are sometimes better than c3 response times. 
...
* Fluctuating counts of incidents but doesn't seem to be an uptick to explain the uptick in response times
* By regions, Midlands is reporting the highest counts and East of England and South West reporting the lowest (this is interesting as South West was reporting longest response times in recent months)  
* By trusts, London is reporting the highest incident counts and Isle of Wight is reporting the lowest followed by North East. 
* This is not split by category so that might influence this. 
...
* C2 incidents make up the most incidents overall, followed by c3, c1 and then c4.  
* Seems to be an overall downward trend of c3 incidents in recent month, whereas a slight upward trend in c1 incidents 
* Upward trends of c1 incidents in South West, Midlands and North West.
* More overlaps in incidents over time between c1, c3-4 for specific trusts
* Upward trend of c1 incidents in East of England, North West, South Western and West Midlands. 
...
* Overall majority of incidents results in transport to ED followed by see and treat. This is the same across all regions and trusts
* Downward trend in convey to ED incidents in recent months across regions and trusts
* But upward trend in hear and treat incidents overall
* In North East and Yorkshire, North West and London (regions), there is a slight upward trend of see and treat incidents 
* In East Midlands, London, North West, Isle of Wight and Yorkshire NHS trust,there is a slight upward trend of see and treat incidents. 
